            ...
            <div className="bg-card/95 backdrop-blur-xl rounded-2xl border-2 border-accent/30 shadow-2xl mx-4">
              ...
              <div className="relative bg-gradient-to-r from-purple-600 to-sky-500 p-6 rounded-t-2xl">
                ...
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-white">{t('loginModal.signInRequired')}</h2>
                    <p className="text-white/80 text-sm">{t('loginModal.accessPremium')}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6">
                <div className="mb-6">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <h3 className="font-semibold text-foreground">{t('loginModal.whySignIn')}</h3>
                  </div>
                  
                  <ul className="space-y-2 text-sm text-muted-foreground">
                    <li className="flex items-center gap-2">
                      <span className="text-green-500">✓</span>
                      <span>{t('loginModal.benefits.aiTools')}</span>
                    </li>
                    <li className="flex items-center gap-2">
                      <span className="text-green-500">✓</span>
                      <span>{t('loginModal.benefits.saveProgress')}</span>
                    </li>
                    <li className="flex items-center gap-2">
                      <span className="text-green-500">✓</span>
                      <span>{t('loginModal.benefits.unlimited')}</span>
                    </li>
                    <li className="flex items-center gap-2">
                      <span className="text-green-500">✓</span>
                      <span>{t('loginModal.benefits.free')}</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <span>{t('loginModal.continueWithGoogle')}</span>
                  </button>
                  ...
                  >
                    ...
                    <span>{t('loginModal.continueWithFacebook')}</span>
                  </button>
                </div>
